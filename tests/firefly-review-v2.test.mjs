...
function candidate(id, body, withMatch) {
  ...
  return {
    id,
    applicationBindingSha256: hash(`application-${id}`),
    status: "unreviewed",
    body,
...
function packet() {
  ...
  const body = {
    ...
    candidates: [candidate("candidate-A", "첫 후보의 압박 장면", true), candidate("candidate-B", "둘째 후보의 압박 장면", false)],
